...
import { ArrowRight, Briefcase, Code, Mail, Linkedin, Github, CheckCircle, ExternalLink, Info } from 'lucide-react';
...
const techStack = ["TypeScript", "React", "Next.js", "Node.js", "Python", "Firebase", "TailwindCSS", "Framer Motion", "ShadCN UI", "Genkit"];
const otherSkills = ["Git", "Docker", "CI/CD", "Agile Methodologies", "Jira", "Figma"];
                ...
                >
                    <div className="container mx-auto max-w-screen-2xl px-4 md:px-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-16">
                            <div>
                                <h3 className="text-2xl font-semibold mb-6 text-center text-accent">Core Tech Stack</h3>
                                <div className="flex flex-wrap justify-center gap-4">
                                    {techStack.map(skill => (
                                        <Badge key={skill} variant="default" className="text-lg py-2 px-4 rounded-lg">{skill}</Badge>
                                    ))}
                                </div>
                            </div>
                            <div>
                                <h3 className="text-2xl font-semibold mb-6 text-center text-accent">Other Skills & Tools</h3>
                                <div className="flex flex-wrap justify-center gap-4">
                                    {otherSkills.map(skill => (
                                        <Badge key={skill} variant="secondary" className="text-lg py-2 px-4 rounded-lg">{skill}</Badge>
                                    ))}
                                </div>
                            </div>
                        </div>
